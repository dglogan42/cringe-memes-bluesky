...
**Version:** 1.24.0 · **Sakura-Mart** era portfolio fuel (synced) — 94 @dglogan42
...
- **Stupid GitHub Projects** — **129** repos across two accounts ([@dglogan42](https://github.com/dglogan42) **94** + [@Thedoctorjpg](https://github.com/Thedoctorjpg) **35**) as one-click meme fuel
- Newest fuel: **[Sakura-Mart](https://github.com/dglogan42/Sakura-Mart)** — ちびマート / CHIBI MART GBA supermarket sim (web + Android APK)
- Also hot: **[Bread](https://github.com/dglogan42/Bread)**, **[Supa-Saver](https://github.com/dglogan42/Supa-Saver)**, **[ToyFinder](https://github.com/dglogan42/ToyFinder)**, **[Hardware-Help](https://github.com/dglogan42/Hardware-Help)**, **[Space-Factory](https://github.com/dglogan42/Space-Factory)**
...
1. Switch between **@dglogan42** (94 repos, newest first — **Sakura-Mart** featured) and **@Thedoctorjpg** (35 repos).
...
Synced from `projects.js` — **94** @dglogan42 repos (newest first; matches public GitHub).
...
├── sw.js                      # Service worker (offline cache v1.24.0)
