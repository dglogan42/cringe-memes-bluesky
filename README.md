...
**Version:** 1.46.0 · **seolleda** era portfolio fuel (synced) — 124 @dglogan42
...
- **Stupid GitHub Projects** — **159** repos across two accounts ([@dglogan42](https://github.com/dglogan42) **124** + [@Thedoctorjpg](https://github.com/Thedoctorjpg) **35**) as one-click meme fuel
- Newest fuel: **[seolleda](https://github.com/dglogan42/seolleda)** — 설레 SEOLLE, phone-first Korean rizz for oppa / unnie
- Also hot: **[Discord-Restream](https://github.com/dglogan42/Discord-Restream)**, **[Bluesky-Replit](https://github.com/dglogan42/Bluesky-Replit)**, **[Sugarpaw](https://github.com/dglogan42/Sugarpaw)**, **[Lacewarrant](https://github.com/dglogan42/Lacewarrant)**
...
1. Switch between **@dglogan42** (124 repos, newest first — **seolleda** featured) and **@Thedoctorjpg** (35 repos).
...
Synced from `projects.js` — **124** @dglogan42 repos (newest first; matches public GitHub).

| Repo | What it is |
|------|------------|
| [seolleda](https://github.com/dglogan42/seolleda) | 설레 SEOLLE — phone-first Korean rizz for oppa / unnie. KakaoTalk line lab, SS-tier board, classic pickups (라면 먹고 갈래), English glow-up, slang, crush practice. Vault offline + optional grok-4.6. MIT. |
| [Stanford-CompSci-Tutor](https://github.com/dglogan42/Stanford-CompSci-Tutor) | Stanford CS B.S. study planner / prep bot (2025–26 sheets). GPA-first quarter maps, program-sheet tracker, course drills, Grok tutor + offline coach. MIT. Not affiliated with Stanford. |
...
├── sw.js                      # Service worker (offline cache v1.46.0)
